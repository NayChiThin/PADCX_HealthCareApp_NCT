...
interface FirebaseApi {
    ...
    fun saveMessage(consultId: String,message:MessageVO,onSuccess: () -> Unit,onFailure: (String) -> Unit)
    ...
    fun getCurrentMessages(consultId: String,onSuccess: (List<MessageVO>) -> Unit,onFailure: (String) -> Unit)
