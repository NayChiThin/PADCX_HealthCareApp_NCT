...
import com.padcx.padcx_healthcareapp_nct.adapters.MessageListAdapter
import com.padcx.padcx_healthcareapp_nct.adapters.PatientDetailListAdapter
import com.padcx.padcx_healthcareapp_nct.mvp.presenters.ChatPresenter
import com.padcx.padcx_healthcareapp_nct.mvp.presenters.impls.ChatPresenterImpl
...
class ChatActivity : BaseActivity(),ChatView {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvDoctorName.text = consult.doctor?.name
        tvSpeciality.text = consult.doctor?.speciality
    ...
    override fun setUpRecyclerView(userName:String){
        ...
        val specialityLayoutManager = object : LinearLayoutManager(this,LinearLayoutManager.VERTICAL,false) {
    ...
    override fun displayLastPositionScrollView() {
